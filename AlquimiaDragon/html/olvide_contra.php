    ...
    <div class="card w-auto p-4 text-center" id="card-login">
        <div class="card-body">
            ...
            <div class="text-start">
                ...
                <p class="h1 mb-4">Introduce tu correo electronico</p>
            </div>
            <!--Formulario ajustar metodo post y dar funcion con JS-->
            <form class="d-flex flex-wrap justify-content-center gap-1 mb-3" method="POST" action="../php/mandar_codigo.php">
                ...
                <div class="col-12 d-flex flex-wrap justify-content-center">
                    <button type="submit" class="btn btn-primary mt-2" id="btn-register" name="enviar">Enviar</button>
                </div>
            </form>
        </div>
    </div>
