    ...
    <div class="card w-auto p-4 text-center" id="card-login">
        <div class="card-body">
            ...
            <div class="text-start">
                ...
                <p class="h1 mb-4">Introduce tu codigo</p>
            </div>
            ...
            <form class="d-flex flex-wrap justify-content-center gap-1 mb-3">
                ...
                <div class="d-flex flex-wrap justify-content-center gap-2">
                    <div class="col-auto mb-4">
                        <input type="text" class="form-control" id="form" placeholder="Codigo">
                    </div>
                </div>
                <!--Boton-->
                <div class="col-12 d-flex flex-wrap justify-content-center">
                    <button type="submit" class="btn btn-primary mt-1" id="btn-reenviar">Renviar</button>
                </div>
                <div class="col-12 d-flex flex-wrap justify-content-center">
                    <button type="submit" class="btn btn-primary mt-2" id="btn-register">Enviar</button>
                </div>
            </form>
        </div>
    </div>
